  ...
  return (
    <div>
      ...
      <div className="aboutAccordion">
        <Accordion className="accordionbout" header="Fiabilité" body="Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées  par nos équipes." />
